...
Micc1D<-fread('/research/xieyeming1/proj_2025/MICC_paper/peak_hg19/shared_peak_1d/hekMiccEcoG_3lanes/hekMiccEcoG_3lanes.narrowpeak',sep='\t',header = F)
head(Micc1D)
...
# read all .narrowPeak files under /research/xieyeming1/proj_2025/wj_n3kJQ1_250829/align/*/*_peaks.narrowPeak
